  ...
  <>
     <main className="overflow-x-hidden pt-24 lg:pt-28 antialiased">
      <div className="relative container">
        ...
        {/* Contact section */}
        <section id="contact">
          <div className="md:flex  justify-between items-center bg-slate-800 rounded-lg px-7  lg:px-16 py-12 ">
   <div className="flex flex-col gap-y-3">
    <Heading title="let`s try our service now!"/>
    <p className="max-w-[35rem] text-lg">  Experience the power of Ocean CRM dashboard for engineering
